            ...
            <td key={1}>
                ...
                :
                    <svg className="svg" viewBox="0 0 24 24">
                        {/* <path className="path" d="M0 0h24v24H0V0z" fill="none" /> */}
                        <path className="path" d="M 14,2 H 6 C 4.9,2 4.01,2.9 4.01,4 L 4,20 c 0,1.1 0.89,2 1.99,2 H 18 c 1.1,0 2,-0.9 2,-2 V 8 Z m 4,18 H 6 V 4 h 7 v 5 h 5 z" />
                    </svg>                
